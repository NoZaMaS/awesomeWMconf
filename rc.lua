...
mylauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu = mymainmenu })
myVolume = awful.widget.watch('bash -c "pamixer --get-volume"', 0)
      ...
      function (c, _, _, button)
        if button == 4 then
         ...
         elseif button == 5 then
          awful.spawn("spawn set-sink-volume @DEFAULT_SINK@ -5%")
        end
      end)
--]]
    --separator
...
----------------------------------------
  ...
  function ()
    ...
    -- File broswer
    awful.key({modkey}, "e", function () awful.spawn(app.fileBrowser) end,
              {description = "open file brower", groupe = "client"}),
    -- Special characters
    awful.key({modkey, "Shift"}, "u", function ()
    awful.spawn(app.specialCharacter)
    end)
)
